...
# Step 3: Run config extends validation (strict)
echo -e "${YELLOW}Step 3: Running config extends validation (strict)...${NC}"
echo ""

if "$SCRIPT_DIR/backend/validate-config-extends-strict.ts"; then
  echo ""
